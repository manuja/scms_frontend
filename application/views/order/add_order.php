...
<section class="content">
                                    ...
                                    <form id="form_apply_bid" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form" action="<?php echo base_url($formUrl) ?>">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                    ...
                                                    <input type="hidden" value="1" name="form_identify" id="form_identify" class="form-control"required>
                                        ...
                                        <div class="col-sm-6">
                                                    ...
                                                    <input style="border-radius:2px" type="text" name="order_need_date" id="order_need_date" class="form-control datepicker" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <!-- <input type="text"  name="orderdescription" id="orderdescription" class="form-control" rows="3"> -->
  ...
  <div class="row">
      <div class="col-lg-10"><span id="success-msg"></div>
  </div>
    <div class="row">
        <div class="col-lg-6">
