                            ...
                            <div class="panel-body">
                                <div class="video-player" style="text-align: center;">
                                    ...
                                    <video id="my-video" class="video-js" controls preload="auto" width="80%" height="auto" poster="<?php if (file_exists('uploads/user_manual/thumbnail/videoplaceholder.jpg')) {
                                        ...
                                        <source src="<?php echo base_url() . 'uploads/user_manual/video/Training_org_eva'; ?>.mp4" type='video/mp4'>
                                        <source src="<?php echo base_url() . 'uploads/user_manual/video/Training_org_eva'; ?>.webm" type='video/webm'>
                                        <p class="vjs-no-js">
