...
$(document).ready(function () {
    ...
    $("#manual_payment_made").click(function (event) {
        ...
        $.ajax({
            url: "../../../MemberRegistration/manualPaymentMade/",
            data: {
                user_tbl_id: user_id
            },
            dataType: "json",
...
//    jQuery( "#registry_form_2" ).submit(function( event ) {
    ...
    function applicationApprove() {
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: '../../../MemberRegistration/afterEditPaymentApplicationApproval',
            data: {
            ...
            success: function (done) {
               ...
               window.location.href='../../../applications/membership/get/'+application_id;
               /* if (response.status === false) {
