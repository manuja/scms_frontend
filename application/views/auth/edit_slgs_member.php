...
<input type="file" class="form-control" name="upload" placeholder="Chose Your Photography" required>
<div class="help-block with-errors"></div>
</div>
</div> -->
...
<div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <a href="<?php echo base_url().'users/'?>" class="btn btn-danger">cancel</a>
                                                    <button type="submit" id="but01"  class="btn btn-info">Update User</button>&nbsp;                                                    
                                                </div>
                                            </div>
                                        </div>
</form>
