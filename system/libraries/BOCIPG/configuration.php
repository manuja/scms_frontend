...
$configArray["gatewayUrl"] = "https://bankofceylon.gateway.mastercard.com/api/nvp";


// Merchant ID supplied by your payments provider
$configArray["merchantId"] = "700182200008";

// API username in the format below where Merchant ID is the same as above
$configArray["apiUsername"] = "Merchant.700182200008";

// API password which can be configured in Merchant Administration
$configArray["password"] = "0a64311ed478444f4143899238431057";
