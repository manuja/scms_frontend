...
if($user_id) {
    ...
    if(isMemberOrStaff($user_id) == '3'){
        ...
        if($temp){
            ...
            $profImage = base_url() . 'assets/images/user.png';
        }
    }else{
        $profImage = base_url() . 'assets/images/user.png';
    }
...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-139719354-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-139719354-2');
    </script>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
            <a href="<?php echo site_url('member_dashboard'); ?>" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"> <img src="<?php echo base_url() . 'assets/'; ?>images/" style="width:30px;height:30px;"/></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">Supply Chain Mgt<b> </b></span>
        </a>
        <nav class="navbar navbar-static-top">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <a href="<?php echo site_url('signout'); ?>" class="fa fa-sign-out">Sign Out</a>
                            </li>
                        </ul>
                    </li>
            ...
            <!-- <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="#" target="_blank">SLGS Web</a>
                    </li>
                </ul>
            </div> -->
        </nav>
