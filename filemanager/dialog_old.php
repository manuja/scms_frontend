                                            ...
                                            <div class="fileupload-buttonbar">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <button type="submit" class="btn btn-primary start">
                                                        ...
                                                        <span>sdfsdfsdfsdfsdfsdfsdfsdfsdf</span>
                                                    </button>
                                                    <button type="submit" class="btn btn-primary start">
                                                        <i class="glyphicon glyphicon-upload"></i>
                ...
                <div class="span12">
                    ...
                    <?php } else { ?>
                        ...
                        <ul class="grid cs-style-2 <?php echo "list-view" . $view; ?>" id="main-item-container">
                            ...
                            $result = mysqli_query($conn, "SELECT groups.is_admin FROM groups INNER JOIN users_groups ON users_groups.group_id = groups.id WHERE users_groups.user_id =" . $user_id);
...
//                            $is_admin = $conn->query($query)->fetch_assoc();
                            $user_type = $row->is_admin;

                            if ($user_type == 2) {


                                $result2 = mysqli_query($conn, "SELECT groups.id FROM groups WHERE groups.id = (SELECT groups.parent_id FROM groups INNER JOIN users_groups ON users_groups.group_id = groups.id WHERE users_groups.user_id =" . $user_id . ")");
                                ...
                                $result3 = mysqli_query($conn, "SELECT member_profile_data.user_member_class FROM member_profile_data WHERE member_profile_data.user_id =" . $user_id);
                                ...
                                $permission = $row->user_member_class;
                            }


                            //    ***************************************************************************************************************************
//
//                            if (!empty($file_array['is_dir'])) {
//                                if ($file_array['is_dir'] == 1) {
                            $result4 = mysqli_query($conn, "SELECT document_archive.dic_id, document_archive.folder_name, document_archive.share_with FROM document_archive WHERE document_archive.select_type = " . $user_type . " AND document_archive.share_with = " . $permission . " AND document_archive.`status` = 1");
...
//                            exit;
                            ...
                            {
                                foreach ($array4 as $id => $item)
                                {


                                    $string = $item['folder_name'];
...
//                                         print_r($value);
                                    ...
                                    if (end($contents) == $value['file'] && $value['is_dir'] == 1) {
                                        // we have a match so we print out the first array element
                                        $new_array[] = $files[$key];
//                                        array_push($new_array, $files[$key]);
                                    }
                                }
                            }
...
//                            exit;
                            ...
                            foreach ($new_array as $file_array)
                            {
...
//                              exit; 
//
//                                    $expolde_folder_name = explode("../source/", $value4['folder_name']);
//                                    $file_name = explode('/', $expolde_folder_name);
//
//                                        $string = $value4['folder_name'];
//                                        $contents = explode('/', $string);
//
// print_r($contents);
//                        $file_name = $expolde_folder_name['1'];
//                                    echo '<br>';
//                                    echo '<br>';
//                                    echo end($contents).'+++';
//                                    print_r($file_array);
//                                    echo '<br>';
//                                        if (end($contents) == $file_array['file'] && $file_array['is_dir'] == 1) {
//    ***************************************************************************************************************************
...
//                                print_r($file);
                                ...
                                if ($file == '..')
                                    ...
                                    echo 'dir';
                                ?> <?php if (!$config['multiple_selection']) { ?>no-selector<?php } ?>" <?php if (($filter != '' && stripos($file, $filter) === false)) echo ' style="display:none;"'; ?>><?php
                                ...
                                ?><figure data-name="<?php echo $file ?>" data-path="<?php echo $rfm_subfolder . $subdir . $file; ?>" class="<?php if ($file == "..") echo "back-"; ?>directory" data-type="<?php
                                    if ($file != "..") {
                                        echo "dir";
                                    }
                                    ?>">
                                        ...
                                        <a class="folder-link" href="dialog.php?<?php echo $get_params . rawurlencode($src) . "&" . ($callback ? 'callback=' . $callback . "&" : '') . uniqid() ?>">
                                            <div class="img-precontainer">
                                                <div class="img-container directory"><span></span>
                                                    <img class="directory-img" data-src="img/<?php echo $config['icon_theme']; ?>/folder<?php
                                        if ($file == "..") {
                                            echo "_back";
                                        }
                                                ?>.png" />
...
//check if is smaller than thumb
                                        ...
                                        <li class="ff-item-type-<?php echo $class_ext;
                                                ?> file <?php if (!$config['multiple_selection']) { ?>no-selector<?php } ?>"  data-name="<?php echo $file; ?>" <?php if (($filter != '' && stripos($file, $filter) === false)) echo ' style = "display:none;"'; ?>><?php
                                        $file_prevent_rename = false;
                                        $file_prevent_delete = false;
                                        if (isset($filePermissions[$file])) {
                                        ...
                                        ?>		
                                            <figure data-name="<?php echo $file ?>" data-path="<?php echo $rfm_subfolder . $subdir . $file; ?>" data-type="<?php
                                            if ($is_img) {
                                                echo "img";
                                            } else {
                                                echo "file";
                ...
                <?php } ?>
                                                        <div class="filetype <?php echo $file_array['extension'] ?> <?php if (in_array($file_array['extension'], $config['editable_text_file_exts'])) echo 'edit-text-file-allowed' ?> <?php
                if (!$is_icon_thumb) {
                    echo "hide";
                }
                                            ...
                                            if ($is_img) {
                                                ...
                                                <figcaption>
                                                    <form action="force_download.php" method="post" class="download-form" id="form<?php echo $nu; ?>">
                                                        ...
                                                        <a title="<?php echo trans('Download') ?>" class="tip-right" href="javascript:void('')" <?php
                                    if ($config['download_files'])
                                        echo "onclick=\"$('#form" . $nu . "').submit();\""
                                        ?>><i class="icon-download <?php if (!$config['download_files']) echo 'icon-white'; ?>"></i></a>
