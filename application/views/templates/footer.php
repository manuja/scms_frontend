...
<script>
    ...
    var idleTime = 0;
    var idleTimeCap  =  <?php if(getSystemVariable('session_expire_redir_time')[0]->system_variable_value){ echo getSystemVariable('session_expire_redir_time')[0]->system_variable_value; }else{ echo '3'; } ?>;
    ...
    function timerIncrement() {
        idleTime = idleTime + 1;
        if (idleTime > idleTimeCap-1) { // 6 minutes
