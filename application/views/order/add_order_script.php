               ...
               
                {
                    mRender: function (data, type, row) {
                      ...
                      if(row[2]!=null){
                        ...
                        bindHtml +='&nbsp;&nbsp;';
                                   bindHtml += '<a id="deleteid" data-toggle="modal" data-target="#delete-staff" title="Delete Stff" class="delete-staff-details ml-1 btn-ext-small btn btn-sm btn-danger" onclick="deleteItemByItem('+ row[2] +')" data-staffid="' + row[2] + '"><i class="fa fa-times"></i></a>';
...
function deleteItemByItem(id)
{
    ...
    jQuery.ajax({
        ...
        success: function (json) {
           ...
           jQuery('#addressedit').val(json[0]['qty']); 
           jQuery("#droporderitemedit").val(json[0]['order_item_id']);
