					...
					<div class="loingimage"><img src="assets/images/readnam.png"></div>
                       <h5 class="content-group">Login to your account<br/>
                        ...
                        <p>
							...
							<!-- <p class="for"><a target="_blank" href="<?php echo base_url('forgot_password'); ?>">Forgot password?</a></p> -->
                        </p>
                        <p><?php echo form_submit(array('name' => 'submit', 'class' => 'btn  btn-flat'), lang('login_submit_btn')); ?><span class="arrow"><img src="assets/images/flechas-vector-png-1.png"></span></p>
                        <?php echo form_close(); ?>
