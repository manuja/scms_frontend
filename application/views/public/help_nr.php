                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="col-md-6 video-player" >
                                    <label>Recognized degrees</label>
                                    <video id="my-video" class="video-js" controls preload="auto" width="80%" height="auto" poster="<?php if (file_exists('uploads/user_manual/thumbnail/videoplaceholder.jpg')) {
                                        ...
                                        <source src="<?php echo base_url() . 'uploads/user_manual/video/Recognized_Degrees'; ?>.mp4" type='video/mp4'>
                                        <source src="<?php echo base_url() . 'uploads/user_manual/video/Recognized_Degrees'; ?>.webm" type='video/webm'>
                                        <p class="vjs-no-js">
                                ...
                                <div class="col-md-6 video-player" >
                                    <label>Non recognized degrees</label>
                                    <video id="my-video" class="video-js" controls preload="auto" width="80%" height="auto" poster="<?php if (file_exists('uploads/user_manual/thumbnail/videoplaceholder.jpg')) {
                                                                                                                                            echo base_url() . 'uploads/user_manual/thumbnail/videoplaceholder.jpg';
                                                                                                                                        } else {
                                                                                                                                            echo base_url().'uploads/user_manual/thumbnail/videoplaceholder.png';
                                                                                                                                        } ?>" data-setup="{}">
                                        <source src="<?php echo base_url() . 'uploads/user_manual/video/Non-recognized_Degree'; ?>.mp4" type='video/mp4'>
                                        <source src="<?php echo base_url() . 'uploads/user_manual/video/Non-recognized_Degree'; ?>.webm" type='video/webm'>
                                        <p class="vjs-no-js">
                                            To view this video please enable JavaScript, and consider upgrading to a web browser that
                                            <a href="https://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a>
                                        </p>
