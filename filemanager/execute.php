...
if (isset($info['extension']) && !(isset($_GET['action']) && $_GET['action'] == 'delete_folder') &&
        !check_extension($info['extension'], $config) && $_GET['action'] != 'create_file') {
    ...
    switch ($_GET['action'])
    {
        ...
        case 'create_folder':
            ...
            if ($config['create_folders']) {
                ...
                $user_classes = $_POST['user_classes'];
...
//exit;
                ...
                $path .= $name;
                $path_thumb .= $name;
                $res = create_folder(fix_path($path, $config), fix_path($path_thumb, $config), $ftp, $config, $select_type, $divisions, $user_classes);
                if (!$res) {
