...
class Ion_auth {
    ...
    public function __construct()
    {
        ...
        $this->load->library(array('email','email_lib'));
...
//                    print_r($data);
//            exit;
                  $abc =  $this->email_lib->sendEmail('testl.pipl@gmail.com',$user->email, $this->lang->line('email_forgotten_password_subject'), $message);
    ...
    public function register($identity, $password, $email, $additional_data = array())
    {
        ...
        $id = $this->ion_auth_model->register($identity, $password, $email, $additional_data);
