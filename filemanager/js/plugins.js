...
//  $('input[name=select_type]').on('click', function (e) {
//      alert();
//        var select_type = $(this).val();
//        if (select_type == 1) {
//
...
!function ($) {
    ...
    function divisions_drop_down(selected, callBack) {
        alert();
        var comboData = '';
        $.post("views/loadComboBox.php", {comboBox: 'vote_code_ComboBox'}, function (e) {
            if (e === undefined || e.length === 0 || e === null) {
                comboData += '<option value="0"> -- No Data Found -- </option>';
                $('#vode_code').html('').append(comboData);
                chosenRefresh();
            } else {
                $.each(e, function (index, qData) {
                    if (selected !== undefined || e !== null || e.length !== 0) {
                        if (parseInt(selected) === parseInt(qData.income_vote_id)) {
                            comboData += '<option value="' + qData.income_ss + '" selected>' + qData.income_vote_code + '</option>';
                        } else {
                            comboData += '<option value="' + qData.income_ss + '">' + qData.income_vote_code + '</option>';
                        }
                    } else {
                        comboData += '<option value="' + qData.income_ss + '">' + qData.income_vote_code + '</option>';
                    }
...
var bootbox = window.bootbox || (function (document, $) {
    ...
    that.prompt = function (/*str, labelCancel, labelOk, cb, defaultVal*/) {
        ...
        var mem_class_group = $('#mem_class_group').val();
        var user_type = $('#user_type').val();
        show_hide1 = "";
        show_hide2 = "";
        if (user_type == 2) {
            show_hide2 = "style='display:none'";
        } else {

            show_hide1 = "style='display:none'";
        }
        var readonly = "";
        if (user_type == 2 && mem_class_group == 39) {
            readonly = "";
...
//        alert(user_type);
        ...
        var radio_checked3 = "";
        if (user_type == 2) {
            var radio_checked2 = "checked";
        } else if (user_type == 3) {
            radio_checked3 = "checked";
        } else {
        ...
        if (mem_class_group == 7) {
            option7 = "selected";
        } else if (mem_class_group == 23) {
            option23 = "selected";
        } else if (mem_class_group == 28) {
            option28 = "selected";
        } else if (mem_class_group == 35) {
            option35 = "selected";
        } else if (mem_class_group == 39) {
            option39 = "selected";
        } else if (mem_class_group == 43) {
            option43 = "selected";
        } else if (mem_class_group == 51) {
            option51 = "selected";
        } else if (mem_class_group == 1) {
            option1 = "selected";
        } else if (mem_class_group == 2) {
            option2 = "selected";
        } else if (mem_class_group == 3) {
            option3 = "selected";
        } else if (mem_class_group == 4) {
            option4 = "selected";
        } else if (mem_class_group == 6) {
            option6 = "selected";
        } else if (mem_class_group == 8) {
            option8 = "selected";
        } else if (mem_class_group == 9) {
            option9 = "selected";
        } else if (mem_class_group == 10) {
            option10 = "selected";
        } else if (mem_class_group == 11) {
            option11 = "selected";
        } else if (mem_class_group == 12) {
            option12 = "selected";
        } else if (mem_class_group == 13) {
            option13 = "selected";
        } else {
            option = "";
        }
        ...
        var form = $("<form></form>");
        form.append("<div class='radio'><label for='radios-0'><input class='" + readonly + "' type='radio' name='select_type' id='radios-0' " + radio_checked2 + " value='2'>Staff only</label></div>\n\
<div class='radio'><label for='radios-1'><input type='radio' class='" + readonly + "' name='select_type' id='radios-1' " + radio_checked3 + " value='3'>Members</label></div>");
        form.append("<select class='input-block-level " + readonly + "' id='divisions' " + show_hide1 + ">\n\
<option value='7' " + option7 + " >Member div</option>\n\
<option value='23' " + option23 + " >Education Div</option>\n\
<option value='28' " + option28 + " >Finance Div</option>\n\
<option value='35' " + option35 + ">Publications Div</option>\n\
<option value='39' " + option39 + ">CEO Div</option><\n\
option value='43' " + option43 + ">Operations Div</option>\n\
<option value='51' " + option51 + ">Techno Div</option></select>");
        form.append("<select class='input-block-level " + readonly + "' id='user_classes' " + show_hide2 + "'>\n\
<option value='1' " + option1 + ">Student</option>\n\
<option value='2' " + option2 + ">Companion</option>\n\
<option value='3' " + option3 + ">Associate</option>\n\
<option value='4' " + option4 + ">Public</option>\n\
<option value='6' " + option6 + ">Associate Member</option>\n\
<option value='7' " + option7 + ">Affiliate Member</option>\n\
<option value='8' " + option8 + ">Corporate Member</option>\n\
<option value='9' " + option9 + ">Fellow</option>\n\
<option value='10' " + option10 + ">Training Organization</option>\n\
<option value='11' " + option11 + ">Honorary Life Member</option>\n\
<option value='12' " + option12 + ">Honorary Life Fellow</option>\n\
<option value='13' " + option13 + ">Honorary Fellow</option></select>");
        ...
        var confirmCallback = function () {
            if (typeof cb === 'function') {
                return cb(form.find("input[type=text]").val(), $('#user_classes').val());
            }
        };
