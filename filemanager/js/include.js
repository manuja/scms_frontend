...
!function (e, a, t) {
        ...
        e.ajax({
            ...
            bootbox.dialog(r, [{
                    ...
                    callback: function () {
                        ...
                        window.editor && (a = window.editor.getData()), e.ajax({
                            type: "POST",
    ...
    function u(a) {
        ...
        if (t.user = 0, t.group = 0, t.all = 0, "undefined" != typeof a && 1 == a) {
            ...
            t.user = r.substr(0, 1), t.group = r.substr(1, 1), t.all = r.substr(2, 1), e.each(t, function (a) {
                ...
                c(t[e], a) ? jQuery(this).prop("checked", !0) : jQuery(this).prop("checked", !1)
            })
        } else
    ...
    function c(a, t) {
        var r = [];
        return r[1] = [1, 3, 5, 7], r[2] = [2, 3, 6, 7], r[4] = [4, 5, 6, 7], a = parseInt(a), t = parseInt(t), e.inArray(a, r[t]) != -1
    }
    ...
    function d(a, t) {
        if ("copy" == t || "cut" == t) {
            var r;
            r = a.closest("figure").attr("data-path"), e.ajax({
                type: "POST",
    ...
    function f(a) {
        bootbox.confirm(jQuery("#lang_paste_confirm").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (t) {
            if (1 == t) {
                var r;
                r = "undefined" != typeof a ? a.closest("figure").attr("data-path") : jQuery("#sub_folder").val() + jQuery("#fldr_value").val(), e.ajax({
                    type: "POST",
    ...
    function p(a, t) {
        var r;
        r = a.hasClass("directory") ? a.find(".rename-folder") : a.find(".rename-file");
        ...
        a.parent().hide(100), e.ajax({
            ...
            if ("" != r)
                ...
                var i;
                i = "undefined" != typeof t ? t.hasClass("back-directory") ? t.find(".path").val() : t.closest("figure").attr("data-path") : jQuery("#sub_folder").val() + jQuery("#fldr_value").val(), e.ajax({
                    type: "POST",
                    url: "execute.php?action=paste_clipboard",
                    data: {
                        path: i
    ...
    function v(e) {
        ...
        if (r.val() > 0) {
            if (1 == r.val())
                ...
                0 == n && (n = 1, jQuery("h4").css("font-size", 12)), t = Math.floor(t / n - 3), jQuery("ul.grid li, ul.grid figure").css("width", t)
            }
            i.hide()
        } else
            a.touch && i.show()
    ...
    function g() {
        1 == jQuery("#popup").val() ? window.close() : ("function" == typeof parent.jQuery(".modal:has(iframe)").modal && parent.jQuery(".modal:has(iframe)").modal("hide"), "undefined" != typeof parent.jQuery && parent.jQuery ? "object" == typeof parent.jQuery.fancybox ? parent.jQuery.fancybox.getInstance().close() : "function" == typeof parent.jQuery.fancybox && parent.jQuery.fancybox.close() : "function" == typeof parent.$.fancybox && parent.$.fancybox.close())
    }

    function _(e) {
        for (var e, a = [/[\300-\306]/g, /[\340-\346]/g, /[\310-\313]/g, /[\350-\353]/g, /[\314-\317]/g, /[\354-\357]/g, /[\322-\330]/g, /[\362-\370]/g, /[\331-\334]/g, /[\371-\374]/g, /[\321]/g, /[\361]/g, /[\307]/g, /[\347]/g], t = ["A", "a", "E", "e", "I", "i", "O", "o", "U", "u", "N", "n", "C", "c"], r = 0; r < a.length; r++)
            e = e.replace(a[r], t[r]);
        return e
    }

    function b(a) {
        return null != a ? ("true" == jQuery("#transliteration").val() && (a = _(a), a = a.replace(/[^A-Za-z0-9\.\-\[\] _]+/g, "")), "true" == jQuery("#convert_spaces").val() && (a = a.replace(/ /g, jQuery("#replace_with").val())), "true" == jQuery("#lower_case").val() && (a = a.toLowerCase()), a = a.replace('"', ""), a = a.replace("'", ""), a = a.replace("/", ""), a = a.replace("\\", ""), a = a.replace(/<\/?[^>]+(>|$)/g, ""), e.trim(a)) : null
    }
    ...
    function w(a, t, r, i, n) {
        null !== r && (r = b(r), e.ajax({
            ...
            return "" != e ? (bootbox.alert(e), !1) : ("" != n && window[n](i, r), !0)
        }))
    }

    function x(a, t, r, i, n) {
        null !== name && (name = b(name), e.ajax({
            type: "POST",
            url: "execute.php?action=" + a,
            data: {
                path: t[0],
            ...
            return "" != e ? (bootbox.alert(e), !1) : ("" != n && window[n](i, name), !0)
        }))
    }
    ...
    function k(a, t) {
        ...
        r.each(function () {
            ...
            if (e.isNumeric(r))
                ...
                r = r + "a" + a.find("h4 a").attr("data-file");
            n[r] = a.html(), l.push(r)
        }), i.each(function () {
            var a = jQuery(this),
                    r = a.find(t).val();
            ...
            return parseFloat(e) - parseFloat(a)
        }) : u.sort(), a && (l.reverse(), u.reverse()), r.each(function (e) {
            jQuery(this).html(n[l[e]])
        }), i.each(function (e) {
            jQuery(this).html(o[u[e]]), jQuery(this).attr("data-name", jQuery(this).children().attr("data-name"))
        })
    }
    ...
    var S = "9.14.0",
            ...
            P = function (e) {
                if (1 == jQuery("#ftp").val())
                    var a = jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val();
                else
                    var a = jQuery("#base_url").val() + jQuery("#cur_dir").val();
                var t = e.find("a.link").attr("data-file");
                return "" != t && null != t && (a += t), t = e.find("h4 a.folder-link").attr("data-file"), "" != t && null != t && (a += t), a
            },
            U = {
                contextActions: {
                    copy_url: function (e) {
                    ...
                    edit_img: function (e) {
                        ...
                        if (1 == jQuery("#ftp").val())
                            var t = jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val() + a;
                        else
                            var t = jQuery("#base_url").val() + jQuery("#cur_dir").val() + a;
                        var r = jQuery("#aviary_img");
                        r.attr("data-name", a), show_animation(), r.attr("src", t).load(C(r.attr("id"), t))
                    },
                    duplicate: function (e) {
                        ...
                        bootbox.prompt(jQuery("#lang_duplicate").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (t) {
                            if (null !== t && (t = b(t), t != a)) {
                                ...
                                w("duplicate_file", r.attr("data-path"), t, r, "apply_file_duplicate")
                            }
                        }, a + " - copy")
                    },
                    select: function (e) {
                        ...
                        if (1 == i && (t = t.replace(jQuery("#base_url").val(), ""), t = t.replace(jQuery("#cur_dir").val(), "")), a = 1 == jQuery("#popup").val() ? window.opener : window.parent, "" != r)
                            if (1 == jQuery("#crossdomain").val())
                                ...
                                n.val(t).trigger("change"), "function" == typeof a.responsive_filemanager_callback && a.responsive_filemanager_callback(r), g()
                            }
                        else
                            apply_any(t)
                    },
                ...
                bindGridEvents: function () {
                    function a(e) {
                        ...
                        "apply_multiple" == a ? (e.find(".selection:visible").trigger("click"), e.find(".selector:visible").trigger("click")) : window[a](e.attr("data-file"), jQuery("#field_id").val())
                    }
                    ...
                    t.on("click", ".modalAV", function (a) {
                        ...
                        bootbox.prompt(jQuery("#rename").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (e) {
                            null !== e && (e = b(e), e != n && w("rename_file", r, e, t, "apply_file_rename"))
                        }, n)
                        ...
                        var a = jQuery(this),
                                ...
                                n = e.trim(i.text());
                        bootbox.prompt(jQuery("#rename").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (e) {
                            null !== e && (e = b(e).replace(".", ""), e != n && w("rename_folder", r, e, t, "apply_folder_rename"))
                        }, n)
                ...
                makeFilters: function (a) {
                    jQuery("#filter-input").on("keyup", function () {
                        ...
                        jQuery(this).val(t), a && E(function () {
                            jQuery("li", "ul.grid ").each(function () {
                                var e = jQuery(this);
                                "" != t && e.attr("data-name").toLowerCase().indexOf(t) == -1 ? e.hide(100) : e.show(100)
                            }), e.ajax({
                        ...
                        a += a.indexOf("?") >= 0 ? "&" : "?", window.location.href = a + "filter=" + e
                    })
                },
                ...
                makeSort: function (a) {
                    jQuery("input[name=radio-sort]").on("click", function () {
                        ...
                        i.removeClass("btn-inverse"), i.find("i").removeClass("icon-white"), jQuery("#filter-input").val(""), r.addClass("btn-inverse"), r.find("i").addClass("icon-white"), "ff-item-type-all" == e ? (a ? jQuery(".grid li").show(300) : window.location.href = jQuery("#current_url").val() + "&sort_by=" + jQuery("#sort_by").val() + "&descending=" + (t ? 1 : 0), "undefined" != typeof Storage && localStorage.setItem("sort", "")) : jQuery(this).is(":checked") && (jQuery(".grid li").not("." + e).hide(300), jQuery(".grid li." + e).show(300), "undefined" != typeof Storage && localStorage.setItem("sort", e)), T()
                    });
                    var t = jQuery("#descending").val();
                    jQuery(".sorter").on("click", function () {
                        var r = jQuery(this);
                        t = jQuery("#sort_by").val() !== r.attr("data-sort") || 0 == t, a ? (e.ajax({
                            url: "ajax_calls.php?action=sort&sort_by=" + r.attr("data-sort") + "&descending=" + (t ? 1 : 0)
                        }), k(t, "." + r.attr("data-sort")), jQuery(" a.sorter").removeClass("descending").removeClass("ascending"), t ? jQuery(".sort-" + r.attr("data-sort")).addClass("descending") : jQuery(".sort-" + r.attr("data-sort")).addClass("ascending"), jQuery("#sort_by").val(r.attr("data-sort")), jQuery("#descending").val(t ? 1 : 0), T()) : window.location.href = jQuery("#current_url").val() + "&sort_by=" + r.attr("data-sort") + "&descending=" + (t ? 1 : 0)
                    })
                }
            };
    jQuery(document).ready(function () {
        if (I && U.makeContextMenu(), "undefined" != typeof Storage && 1 != jQuery("#type_param").val() && 3 != jQuery("#type_param").val()) {
            var t = localStorage.getItem("sort");
            if (t) {
                var n = jQuery("#" + t);
                n.addClass("btn-inverse"), n.find("i").addClass("icon-white"), jQuery(".grid li").not("." + t).hide(300), jQuery(".grid li." + t).show(300)
            }
        }
        if (jQuery(".selector").on("click", function (e) {
            e.stopPropagation(), jQuery(".selection:checkbox:checked:visible").length > 0 ? jQuery("#multiple-selection").show(300) : jQuery("#multiple-selection").hide(300)
        }), jQuery("#full-img").on("click", function () {
            jQuery("#previewLightbox").lightbox("hide")
        }), jQuery("body").on("click", function () {
            jQuery(".tip-right").tooltip("hide")
        }), U.bindGridEvents(), parseInt(jQuery("#file_number").val()) > parseInt(jQuery("#file_number_limit_js").val()))
            var o = !1;
        else
            var o = !0;
        U.makeSort(o), U.makeFilters(o), U.uploadURL(), jQuery("#info").on("click", function () {
            bootbox.alert('<div class="text-center"><br/><br/><br/><p><strong>test FILE MANAGER</strong><br/>Desingned and developed by test Infotec <br> </p></div>'); //<small>test WIjesinghe</small>
            ...
            bootbox.prompt(jQuery("#insert_folder_name").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (a) {
                ...
                if (null !== a) {
                    ...
                    var user_classes = $('#user_classes').val();
            ...
            jQuery("#view").val(t), jQuery("ul.grid").addClass("list-view" + t), jQuery(".sorter-container").addClass("list-view" + t), a.attr("data-value") >= 1 ? v(14) : (jQuery("ul.grid li").css("width", 126), jQuery("ul.grid figure").css("width", 122)), T()
        ...
        }), O = new LazyLoad, A = new Clipboard(".btn")
        ...
        if (1 == u.length && (c = u[0]), "" != t)
            if (1 == jQuery("#crossdomain").val())
                ...
                s.val(c).trigger("change"), 0 == i ? "function" == typeof r.responsive_filemanager_callback && r.responsive_filemanager_callback(t) : "function" == typeof r[i] && r[i](t), g()
            }
        else {
            for (var d = 0; d < u.length; d++) {
                ...
                y = y.toLowerCase();
                var v = u[d];
                e.inArray(y, ext_img) > -1 ? (jQuery("#add_time_to_img").val() && (v = v + "?" + (new Date).getTime()), n += '<img src="' + v + '" alt="' + p + '" /> ') : e.inArray(y, o) > -1 ? n += '<video controls source src="' + v + '" type="video/' + y + '">' + p + "</video> " : e.inArray(y, l) > -1 ? ("mp3" == y && (y = "mpeg"), n += '<audio controls src="' + v + '" type="audio/' + y + '">' + p + "</audio> ") : n += '<a href="' + v + '" title="' + p + '">' + p + "</a> "
            }
            1 == jQuery("#crossdomain").val() ? r.postMessage({
                ...
                field_id: null,
                html: n
            }, "*") : parent.tinymce.majorVersion < 4 ? (parent.tinymce.activeEditor.execCommand("mceInsertContent", !1, n), parent.tinymce.activeEditor.windowManager.close(parent.tinymce.activeEditor.windowManager.params.mce_window_id)) : (parent.tinymce.activeEditor.insertContent(n), parent.tinymce.activeEditor.windowManager.close())
        }
        ...
        if (1 == i.length && (n = i[0]), "" != a)
            if (1 == jQuery("#crossdomain").val())
                ...
                l.val(n).trigger("change"), 0 == r ? "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(a) : "function" == typeof t[r] && t[r](a), g()
            }
        else
            apply_any(i[0])
        ...
        if (1 == i.length && (n = i[0]), "" != a)
            if (1 == jQuery("#crossdomain").val())
                ...
                var l = jQuery("#" + a, t.document);
                l.val(n).trigger("change"), 0 == r ? "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(a) : "function" == typeof t[r] && t[r](a),
                        g()
            }
        else
            apply_any(i[0])
        ...
        i.attr("id", n), i.find(".tip-right").attr("onclick", "jQuery('#" + n + "').submit();")
        ...
        n = n ? "." + n : "", r.each(function () {
            ...
            if (e)
                jQuery(this).attr("src", e.replace(i, a + n) + "?time=" + (new Date).getTime());
            else {
        ...
        t = l.attr("data-url"), "undefined" != typeof t && t && l.attr("data-url", t.replace(encodeURIComponent(i), encodeURIComponent(a + n))), e.parent().attr("data-name", a + n), e.attr("data-name", a + n), e.find(".name_download").val(a + n);
