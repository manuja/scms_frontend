...
//$prev_folder=array();
            ...
            <div class="row-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><small class="hidden-phone">(<span id="files_number"><?php echo $current_files_number . "</span> " . trans('Files'); ?>)</small></li>
...
//                            $is_admin = $conn->query($query)->fetch_assoc();
                            ...
                            <input type="hidden" id="mem_class_group" value="<?php echo $permission; ?>" />

                            <?php
                            if ($permission == 39 && $user_type == 2) {
